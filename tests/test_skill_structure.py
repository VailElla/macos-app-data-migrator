...
class SkillStructureTests(unittest.TestCase):
    ...
    def test_low_space_and_finder_safety_contract_is_present(self) -> None:
        ...
        self.assertIn("目标端新增的受保护 `com.apple.provenance`", skill)
        self.assertIn("源端已有的同名属性仍须完全一致", skill)
        ...
        self.assertIn("目标端任一应用条目新增的受保护 provenance", checklist)
        self.assertIn("destination-only protected provenance may appear on any app entry", checklist)
